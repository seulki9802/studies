...
function gameStart() {
  ...
  // addInput(canvas.width/2, canvas.height/2);
}
...
function gameOver() {
  ...
  ctx.fillText("Your scroe:" + score, canvas.width/2, canvas.height/1.85);
...
function gameComplete() {
  ...
  ctx.fillText("Your scroe:" + score, canvas.width/2, canvas.height/1.9);
