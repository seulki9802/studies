export class Map {
  ...
  ready(){
    ...
    // var a = d3.json("https://unpkg.com/world-atlas@1/world/110m.json");
    // console.log(a);

		// const test = require("https://unpkg.com/world-atlas@1/world/110m.json");
    // console.log(test);

    // console.log(a);
		// var testD = d3.json("https://unpkg.com/world-atlas@1/world/110m.json");
    // console.log(testD);
    // var q = d3.queue();
  }
