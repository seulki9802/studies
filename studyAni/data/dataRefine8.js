export class DataRefine {
  ...
  selectInfo(string, location, char1, char2) {
    ...
    if (string[char1] == undefined) {
      ...
      if(location == "before") { refineString = string.str.slice(0, string[char1]); } //char1 미 포함
      else if(location == "middle") { refineString = string.str.slice(string[char1], string[char2] + 1); } //char1,2 포함
      else if(location == "after") { refineString = string.str.slice(string[char1] + 1, ); } //char1 포함
      return refineString;
    }
