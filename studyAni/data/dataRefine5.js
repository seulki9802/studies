export class DataRefine {
  ...
  animate(ctx, stageWidth, stageHeight, fontSize) {
    ...
    for(var i = 0; i < this.string.length; i ++) {
      ...
      if (startX - this.dx > 0 && startX + this.dx < stageWidth && this.down == 1) {
      ...
      else if (startX  - this.dx2 + ctx.measureText(beforeSemi).width > stageWidth / 3 && this.down == 2) {
      ...
      else if (stageWidth / 3 + this.dx3 < stageWidth / 3 * 2 && this.down == 3) {
